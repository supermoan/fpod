#' @description
#' Read 'FPOD' and 'CPOD' data into 'R' directly from the
...
#' * vignette 1 - getting started: Type `vignette("fpod", package = "fpod")`
#' * vignette 2 - advanced usage: Type `vignette("advanced-usage", package = "fpod")`
