#' @description
#' Description: This package reads FPOD and CPOD data into R directly from the
...
#' * package website [https://supermoan.github.io/fpod/](https://supermoan.github.io/fpod/)

#'
#' @keywords internal
#' @seealso [fp_read()], [fp_summarize()], [fp_find_buzzes()]
"_PACKAGE"
